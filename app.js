document.addEventListener("DOMContentLoaded", function () {
  fetch("https://raw.githubusercontent.com/freeCodeCamp/ProjectReferenceData/master/global-temperature.json")
      ...
      .then(data => {
          ...
          const xAxisLabelYPosition = isMobile ? (height + 60) : (height + margin.bottom / 3);
          const xAxisLabelXPosition = width / 2; // Center the label along the x-axis

          svg.append("text")
              .attr("transform", "translate(" + xAxisLabelXPosition + "," + xAxisLabelYPosition + ")")
